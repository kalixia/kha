...
describe('Controllers Tests ', function () {
    ...
    describe('WelcomeController', function() {
        ...
        it('should be on the first step', function() {
            expect($scope.currentStep.number).toBe(1);
        });

        it('should move to next step when clicking on appropriate button', function() {
            //WHEN
            $scope.nextStep();
            //THEN
            expect($scope.currentStep.number).toBe(2);
        });
